...
MODELS = [
    ...
    # "/home/cmq/.cache/modelscope/hub/Qwen/Qwen2___5-7B-Instruct"
...
def test_models(
    ...
    for i in range(len(vllm_outputs)):
        print("vllm_outputs: ", vllm_outputs[i][1])
        print("hf_outputs: ", hf_outputs[i][1]) 
        print("\n")
    
    
    # for output in vllm_outputs:
    #     generated_text = output[1]
    #     print(f"vllm  Generated text: {generated_text!r}")
        
    # for output in hf_outputs:
    #     generated_text = output[1]
    #     print(f"hf  Generated text: {generated_text!r}")
    check_outputs_equal(
