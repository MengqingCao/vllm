...
def get_kv_cache_planner(vllm_config: VllmConfig):
    """Resolve the model-specific KV cache planner."""
    ...
    if planner_cls_path is not None:
        ...
        from vllm.v1.core.model_kv_cache_planner import ModelKVCachePlanner

        planner_cls = ModelKVCachePlanner
